...
% \newcommand{\mytodonotesoptions}{textwidth=40mm}
...
\newcommand{\myauthorwithexistingtitles}{\myauthor{}}  %% including
                                ...
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{Erkennung sequenzieller Aufgabenabfolgen in gelegten Prozessmodellen}  %% also used for PDF metadata (hyperref)
...
\newcommand{\mysubmissionmonth}{Mai} %% month you are handing in
\newcommand{\mysubmissionyear}{2018} %% year you are handing in
\newcommand{\mysubmissiontown}{Steyr} %% town of handing in (or \myhometown)
...
\hyphenation{ex-am-ple hy-phen-ate Le-ge-ri-cht-ung fu-nk-tion-iert Ver-bind-ung-en be-tra-cht-et}  %% in order to use German umlauts
...
\input{einleitung}   %% remove this line to get rid of the style chapter
\input{hintergrund}
\input{empfehlungen}
\input{analyse}
\input{algorithmus}   %% remove this line to get rid of the example chapter
\input{ergebnisse}
\input{diskussion}
